...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("https://t.me/movies_updet") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '').split()]
